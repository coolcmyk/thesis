...
\label{cha:pengujian}
%-----------------------------------------------------------------------------%
Bab ini akan menyajikan realisasi implementasi, hasil pengujian DroneVL Arena, dan analisis perbandingan \textit{backend} VLM. Seluruh hasil akan dilaporkan berdasarkan log eksperimen yang dihasilkan oleh evaluator.
