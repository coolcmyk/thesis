...
% Informasi dokumen
%-----------------------------------------------------------------------------%
\var{\judul}{DroneVLM: Adaptor VLM Agnostik-Model untuk Navigasi UAV Semantik di CoSyS-AirSim}
\Var{\Judul}{\MakeUppercase{\judul}}

\var{\judulInggris}{DroneVLM: A Model-Agnostic VLM Adapter for Semantic UAV Navigation in CoSyS-AirSim}
